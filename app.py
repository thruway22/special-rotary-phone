...
st.title('💰 BCTDTS')
st.write('A quick and easy timesheet maker for BCTD Baker boys. Created by: Saleh.')

# simple, advanced = st.tabs(['Simple', 'Advanced'])
form = st.form('input_form')
left, middle, right = form.columns ([2, 1, 1])
employee_name = left.text_input('Full Name')
employee_id = middle.number_input('Employee ID', step=1, min_value=0)
